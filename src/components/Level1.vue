...
<template>
    <div class="w-full nes-container with-title">
        ...
        <div class="flex flex-col">
          <div class="flex">
            <img class="w-28" src="@/assets/8-bit-rabbit.png" alt="rabbit">
            <div class="nes-balloon from-left">
              <p class="typewriter">What does a rabbit eat?</p>
            </div>
          </div>
          <div class="flex flex-row-reverse">
            ...
            <div class="nes-balloon from-right capitalize is-dark">
              ...
              <div v-else class="flex flex-col">
                <button class="nes-btn" @click="checkAnswer(true,'carrot')">Carrot</button>
                <button class="nes-btn" @click="checkAnswer(false,'apple')">Apple</button>
                <button class="nes-btn" @click="checkAnswer(false,'banana')">Banana</button>
              </div>
            </div>
          </div>
          <div v-if="isCorrect === true" class="flex">
            <img class="w-28" src="@/assets/8-bit-rabbit.png" alt="rabbit">
            <div class="nes-balloon from-left">
              <p class="typewriter">Wow, How did you know that?! <i class="nes-icon star"></i></p>
          ...
          <div v-else-if="isCorrect === false && isCorrect !== null" class="flex">
            <img class="w-28" src="@/assets/8-bit-rabbit.png" alt="rabbit">
            <div class="nes-balloon from-left">
              <p class="typewriter">Nah, can't eat that <i class="nes-icon close"></i></p>
            </div>
          </div>
        </div>
      </div>
